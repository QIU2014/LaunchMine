...
import io.github.qiu2014.launchmine.utils.InstanceUtils;
import io.github.qiu2014.launchmine.utils.JsonUtils;
import io.github.qiu2014.launchmine.utils.LaunchUtils;
...
public class UI {
    ...
    public Logger uiLogger = LogManager.getLogger();
    ...
    private void startMinecraftInstance(String displayName) {
        ...
        new Thread(() -> {
            try {
                ...
                // Parse options
                int memoryMB = main.getPreferencesHandler().getMemory();
                int width = main.getPreferencesHandler().getMinecraftWidth();
                int height = main.getPreferencesHandler().getMinecraftHeight();
    ...
    public void showOptionsDialog() {
        try {
            ...
            uiLogger.fatal(e.getStackTrace());
        }
    }
